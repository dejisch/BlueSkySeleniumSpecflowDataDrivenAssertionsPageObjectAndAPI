...
namespace BlueSkySeleniumSpecflowWaitsDataDrivenAssertionsPageObjectAndAPI.Features
{
...
#line hidden
        ...
        public virtual void APITests()
        {
            string[] tagsOfScenario = new string[] {
                    "mytag"};
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("API Tests", null, new string[] {
                        "mytag"});
#line 5
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 6
 testRunner.Given("I have access to the url", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
            }
